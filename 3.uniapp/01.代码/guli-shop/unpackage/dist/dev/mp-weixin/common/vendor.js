...
var _config = _interopRequireDefault(__webpack_require__(/*! ./config.js */ 26));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /*
                                                                                                                                                           	请求基础路径与小程序不同
                                                                                                                                                           		...
                                                                                                                                                           		解决:通过uni.getSystemInfoSync()可以获取到当前手机信息
                                                                                                                                                           			...
                                                                                                                                                           			浏览器中platform是"ios"
                                                                                                                                                           */var baseUrl = "";var _uni$getSystemInfoSyn = uni.getSystemInfoSync(),platform = _uni$getSystemInfoSyn.platform;if (platform === "devtools") {// 能进入此处就说明当前运行环境是小程序
  baseUrl = _config.default.mpHost;} else if (platform === "ios") {// 能进入此处就说明当前运行环境是ios系统的浏览器
