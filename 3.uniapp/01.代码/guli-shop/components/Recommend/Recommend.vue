<template>
	<view class="recommendContainer">
		...
		<view class="policyDescList">
			<view class="policyDescItem" v-for="item in indexData.policyDescList" :key="item.desc">
		...
		<!-- CategoryList导航指南区域 -->
		<CategoryList v-for="categoryData in indexData.categoryModule" :categoryData="categoryData" :key="categoryData.titlePicUrl"/>
	</view>
</template>
